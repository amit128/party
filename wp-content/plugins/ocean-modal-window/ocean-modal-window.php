...
final class Ocean_Modal_Window {
	...
	public static function register_post_type() {
		register_post_type( 'ocean_modal_window', apply_filters( 'ocean_modal_window_args', array(
			'labels' => array(
	...
	public function customize_preview_js() {
		...
		wp_localize_script( 'omw-customizer', 'oceanModalWindow', array(
	...
	public function customize_register( $wp_customize ) {
		 ...
		 * Section
		 */
		$wp_customize->add_section( 'omw_general_section' , array(
		 ...
		 * Custom Width
		 */
		$wp_customize->add_setting( 'omw_custom_width', array(
			'transport' 			=> 'postMessage',
			'default'           	=> '700',
			'sanitize_callback' 	=> 'oceanwp_sanitize_number',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Range_Control( $wp_customize, 'omw_custom_width', array(
		 ...
		 * Custom Height
		 */
		$wp_customize->add_setting( 'omw_custom_height', array(
			'transport' 			=> 'postMessage',
			'default'           	=> '0',
			'sanitize_callback' 	=> 'oceanwp_sanitize_number',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Range_Control( $wp_customize, 'omw_custom_height', array(
		 ...
		 * Background Image
		 */
		$wp_customize->add_setting( 'omw_background_image', array(
			'transport' 			=> 'postMessage',
			'default'           	=> '',
			'sanitize_callback' 	=> 'oceanwp_sanitize_image',
		) );

		$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'omw_background_image', array(
		 ...
		 * Section
		 */
		$wp_customize->add_section( 'omw_styling_section' , array(
		 ...
		 * Padding
		 */
		$wp_customize->add_setting( 'omw_padding', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'wp_filter_nohtml_kses',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'omw_padding', array(
		 ...
		 * Border Width
		 */
		$wp_customize->add_setting( 'omw_border_width', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'wp_filter_nohtml_kses',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'omw_border_width', array(
		 ...
		 * Border Type
		 */
		$wp_customize->add_setting( 'omw_border_type', array(
			'transport' 			=> 'postMessage',
			'default'           	=> 'solid',
			'sanitize_callback' 	=> 'oceanwp_sanitize_select',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'omw_border_type', array(
		 ...
		 * Border Radius
		 */
		$wp_customize->add_setting( 'omw_border_radius', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'wp_filter_nohtml_kses',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'omw_border_radius', array(
		 ...
		 * Section
		 */
		$wp_customize->add_section( 'omw_colors_section' , array(
		 ...
		 */
		$wp_customize->add_setting( 'omw_overlay_bg', array(
			'transport' 			=> 'postMessage',
			'default'           	=> '#000000',
			'sanitize_callback' 	=> 'oceanwp_sanitize_color',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'omw_overlay_bg', array(
		 ...
		 * Overlay Opacity
		 */
		$wp_customize->add_setting( 'omw_overlay_opacity', array(
			'transport' 			=> 'postMessage',
			'default'           	=> '0.9',
			'sanitize_callback' 	=> 'oceanwp_sanitize_number',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Range_Control( $wp_customize, 'omw_overlay_opacity', array(
		 ...
		 * Background Color
		 */
		$wp_customize->add_setting( 'omw_modal_bg', array(
			'transport' 			=> 'postMessage',
			'default'           	=> '#ffffff',
			'sanitize_callback' 	=> 'oceanwp_sanitize_color',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'omw_modal_bg', array(
		 ...
		 * Border Color
		 */
		$wp_customize->add_setting( 'omw_modal_border_color', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'oceanwp_sanitize_color',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'omw_modal_border_color', array(
		 ...
		 * Text Color
		 */
		$wp_customize->add_setting( 'omw_modal_text_color', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'oceanwp_sanitize_color',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'omw_modal_text_color', array(
		 ...
		 * Title Color
		 */
		$wp_customize->add_setting( 'omw_modal_title_color', array(
			'transport' 			=> 'postMessage',
			'default'           	=> '#333333',
			'sanitize_callback' 	=> 'oceanwp_sanitize_color',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'omw_modal_title_color', array(
		 ...
		 */
		$wp_customize->add_setting( 'omw_modal_close_btn_bg', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'oceanwp_sanitize_color',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'omw_modal_close_btn_bg', array(
		 ...
		 */
		$wp_customize->add_setting( 'omw_modal_close_btn_hover_bg', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'oceanwp_sanitize_color',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'omw_modal_close_btn_hover_bg', array(
		 ...
		 * Close Button Color
		 */
		$wp_customize->add_setting( 'omw_modal_close_btn_color', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'oceanwp_sanitize_color',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'omw_modal_close_btn_color', array(
		 ...
		 */
		$wp_customize->add_setting( 'omw_modal_close_btn_hover_color', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'oceanwp_sanitize_color',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'omw_modal_close_btn_hover_color', array(
		 ...
		 * Section
		 */
		$wp_customize->add_section( 'omw_typography_section' , array(
		 ...
		 * Font Size
		 */
		$wp_customize->add_setting( 'omw_font_size', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'wp_filter_nohtml_kses',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'omw_font_size', array(
		 ...
		 * Font Family
		 */
		$wp_customize->add_setting( 'omw_font_family', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'sanitize_text_field',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Typography_Control( $wp_customize, 'omw_font_family', array(
		 ...
		 * Font Weight
		 */
		$wp_customize->add_setting( 'omw_font_weight', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'oceanwp_sanitize_select',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'omw_font_weight', array(
		 ...
		 * Font Style
		 */
		$wp_customize->add_setting( 'omw_font_style', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'oceanwp_sanitize_select',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'omw_font_style', array(
		 ...
		 * Text Transform
		 */
		$wp_customize->add_setting( 'omw_text_transform', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'oceanwp_sanitize_select',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'omw_text_transform', array(
		 ...
		 * Line Height
		 */
		$wp_customize->add_setting( 'omw_line_height', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'wp_filter_nohtml_kses',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'omw_line_height', array(
		 ...
		 * Letter Spacing
		 */
		$wp_customize->add_setting( 'omw_letter_spacing', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'wp_filter_nohtml_kses',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'omw_letter_spacing', array(
		 ...
		 * Section
		 */
		$wp_customize->add_section( 'omw_tablet_device_section' , array(
		 ...
		 * Tablet Custom Width
		 */
		$wp_customize->add_setting( 'omw_tablet_custom_width', array(
			'transport' 			=> 'postMessage',
			'default'           	=> '700',
			'sanitize_callback' 	=> 'oceanwp_sanitize_number',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Range_Control( $wp_customize, 'omw_tablet_custom_width', array(
			'label'	   				=> esc_html__( 'Custom Width (px)', 'ocean-modal-window' ),
		 ...
		 */
		$wp_customize->add_setting( 'omw_tablet_custom_height', array(
			'transport' 			=> 'postMessage',
			'default'           	=> '0',
			'sanitize_callback' 	=> 'oceanwp_sanitize_number',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Range_Control( $wp_customize, 'omw_tablet_custom_height', array(
			'label'	   				=> esc_html__( 'Custom Height (px)', 'ocean-modal-window' ),
			'section'  				=> 'omw_tablet_device_section',
		 ...
		 * Tablet Padding
		 */
		$wp_customize->add_setting( 'omw_tablet_padding', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'wp_filter_nohtml_kses',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'omw_tablet_padding', array(
			'label'	   				=> esc_html__( 'Padding', 'ocean-modal-window' ),
			'description'	   		=> esc_html__( 'Format: top right bottom left.', 'ocean-modal-window' ),
			'type' 					=> 'text',
			'section'  				=> 'omw_tablet_device_section',
		 ...
		 * Tablet Font Size
		 */
		$wp_customize->add_setting( 'omw_tablet_font_size', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'wp_filter_nohtml_kses',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'omw_tablet_font_size', array(
			'label'	   				=> esc_html__( 'Font Size', 'ocean-modal-window' ),
			'description'	   		=> esc_html__( 'Enter your custom font size (px - em - rem).', 'ocean-modal-window' ),
			'type' 					=> 'text',
			'section'  				=> 'omw_tablet_device_section',
		 ...
		 * Tablet Line Height
		 */
		$wp_customize->add_setting( 'omw_tablet_line_height', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'wp_filter_nohtml_kses',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'omw_tablet_line_height', array(
			'label'	   				=> esc_html__( 'Line Height', 'ocean-modal-window' ),
			'description'	   		=> esc_html__( 'Enter your custom line height (px - em - rem).', 'ocean-modal-window' ),
			'type' 					=> 'text',
			'section'  				=> 'omw_tablet_device_section',
		 ...
		 */
		$wp_customize->add_setting( 'omw_tablet_letter_spacing', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'wp_filter_nohtml_kses',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'omw_tablet_letter_spacing', array(
			'label'	   				=> esc_html__( 'Letter Spacing', 'ocean-modal-window' ),
			'description'	   		=> esc_html__( 'Enter your custom letter spacing (px - em - rem).', 'ocean-modal-window' ),
			'type' 					=> 'text',
			'section'  				=> 'omw_tablet_device_section',
		 ...
		 * Section
		 */
		$wp_customize->add_section( 'omw_mobile_device_section' , array(
		 ...
		 * Mobile Custom Width
		 */
		$wp_customize->add_setting( 'omw_mobile_custom_width', array(
			'transport' 			=> 'postMessage',
			'default'           	=> '700',
			'sanitize_callback' 	=> 'oceanwp_sanitize_number',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Range_Control( $wp_customize, 'omw_mobile_custom_width', array(
			'label'	   				=> esc_html__( 'Custom Width (px)', 'ocean-modal-window' ),
		 ...
		 */
		$wp_customize->add_setting( 'omw_mobile_custom_height', array(
			'transport' 			=> 'postMessage',
			'default'           	=> '0',
			'sanitize_callback' 	=> 'oceanwp_sanitize_number',
		) );

		$wp_customize->add_control( new OceanWP_Customizer_Range_Control( $wp_customize, 'omw_mobile_custom_height', array(
			'label'	   				=> esc_html__( 'Custom Height (px)', 'ocean-modal-window' ),
			'section'  				=> 'omw_mobile_device_section',
		 ...
		 * Mobile Padding
		 */
		$wp_customize->add_setting( 'omw_mobile_padding', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'wp_filter_nohtml_kses',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'omw_mobile_padding', array(
			'label'	   				=> esc_html__( 'Padding', 'ocean-modal-window' ),
			'description'	   		=> esc_html__( 'Format: top right bottom left.', 'ocean-modal-window' ),
			'type' 					=> 'text',
			'section'  				=> 'omw_mobile_device_section',
		 ...
		 * Mobile Font Size
		 */
		$wp_customize->add_setting( 'omw_mobile_font_size', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'wp_filter_nohtml_kses',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'omw_mobile_font_size', array(
			'label'	   				=> esc_html__( 'Font Size', 'ocean-modal-window' ),
			'description'	   		=> esc_html__( 'Enter your custom font size (px - em - rem).', 'ocean-modal-window' ),
			'type' 					=> 'text',
			'section'  				=> 'omw_mobile_device_section',
		 ...
		 * Mobile Line Height
		 */
		$wp_customize->add_setting( 'omw_mobile_line_height', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'wp_filter_nohtml_kses',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'omw_mobile_line_height', array(
			'label'	   				=> esc_html__( 'Line Height', 'ocean-modal-window' ),
			'description'	   		=> esc_html__( 'Enter your custom line height (px - em - rem).', 'ocean-modal-window' ),
			'type' 					=> 'text',
			'section'  				=> 'omw_mobile_device_section',
		 ...
		 */
		$wp_customize->add_setting( 'omw_mobile_letter_spacing', array(
			'transport' 			=> 'postMessage',
			'sanitize_callback' 	=> 'wp_filter_nohtml_kses',
		) );

		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'omw_mobile_letter_spacing', array(
			'label'	   				=> esc_html__( 'Letter Spacing', 'ocean-modal-window' ),
			'description'	   		=> esc_html__( 'Enter your custom letter spacing (px - em - rem).', 'ocean-modal-window' ),
			'type' 					=> 'text',
			'section'  				=> 'omw_mobile_device_section',
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'omw-js-scripts', plugins_url( '/assets/js/main.min.js', __FILE__ ), array( 'jquery', 'oceanwp-main' ), $this->version, true );
	...
	public function load_fonts() {
		...
		$query = new WP_Query( array( 'post_type' => 'ocean_modal_window', 'posts_per_page' => -1 ) );
...
if ( ! function_exists( 'ocean_modal_window_fs' ) ) {
    ...
    function ocean_modal_window_fs() {
	    ...
	    if ( ! isset( $ocean_modal_window_fs ) ) {
		    $ocean_modal_window_fs = OceanWP_EDD_Addon_Migration::instance( 'ocean_modal_window_fs' )->init_sdk( array(
			    'id'              => '3814',
